  ...
  $(function() {
    ...
    return $container.infinitescroll({
      ...
      return $newElems.imagesLoaded(function() {
        ...
        return $container.masonry('appended', $newElems, true);
      });
    });
  });
...
(function() {
  +(function($) {
     ...
     * The zoom service
     */
    var Zoom, ZoomService;
    ZoomService = function() {
    ...
    ZoomService.prototype._scrollHandler = function(e) {
      ...
      deltaY = this._initialScrollPosition - $(window).scrollTop();
    ...
    Zoom.prototype._zoomOriginal = function() {
      ...
      this._overlay.id = 'zoom-overlay';
      document.body.appendChild(this._overlay);
      this._calculateZoom();
      this._triggerAnimation();
    };
    Zoom.prototype._calculateZoom = function() {
      var imageAspectRatio, maxScaleFactor, originalFullImageHeight, originalFullImageWidth, scrollTop, viewportAspectRatio, viewportHeight, viewportWidth;
      this._targetImage.offsetWidth;
      originalFullImageWidth = this._fullWidth;
    ...
    Zoom.prototype._triggerAnimation = function() {
      var imageCenterX, imageCenterY, imageOffset, imageWrapTransform, scrollTop, targetTransform, viewportX, viewportY;
      this._targetImage.offsetWidth;
      imageOffset = $(this._targetImage).offset();
      scrollTop = $(window).scrollTop();
      viewportY = scrollTop + $(window).height() / 2;
      viewportX = $(window).width() / 2;
      imageCenterY = imageOffset.top + this._targetImage.height / 2;
      imageCenterX = imageOffset.left + this._targetImage.width / 2;
      this._translateY = viewportY - imageCenterY;
      this._translateX = viewportX - imageCenterX;
      targetTransform = 'scale(' + this._imgScaleFactor + ')';
      imageWrapTransform = 'translate(' + this._translateX + 'px, ' + this._translateY + 'px)';
