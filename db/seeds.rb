...
# 10.times do |i|
#   i += 1
#   user = User.where(name: "test_seed#{i}", participation: "TECH::CAMP-Term#{i}", occupation: "Mentor", profile: "seed test", email: "test+seed#{i}@test.com", encrypted_password: "12121212", avatar: open("#{Rails.root}/app/assets/images/noimage.png")).first_or_create
